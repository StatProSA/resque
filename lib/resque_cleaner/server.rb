  ...
  module Server
    ...
    def self.included(base)
      ...
      base.class_eval do
        ...
        %w( cleaner cleaner_list cleaner_dump ).each do |page|
          post "/#{page}/?" do
    ...
    def build_urls
      ...
      @list_url = "cleaner_list?#{params}&namespace=#{current_namespace}"
      @dump_url = "cleaner_dump?#{params}&namespace=#{current_namespace}"
    end
